...
const SERVICES = [
  {
    title: "Pitch Deck Orchestration",
    price: "₹30,000",
    features: ["VC narrative structure", "Professional investor-ready design"],
    featured: false,
    color: "#15A9FF",
  },
  {
    ...
    price: "₹55,000",
    features: ["3–5 year projections", "Unit economics", "Cash flow analysis"],
    featured: false,
    color: "#00C853",
  },
  {
    title: "Growth Stage Advisory",
    price: "₹65,000",
    features: ["Valuation analysis", "Fundraising strategy", "Growth readiness"],
    featured: false,
    color: "#FFC107",
  },
  {
    title: "Investor-Ready Bundle",
    price: "₹80,000",
    features: ["Financial model", "Valuation", "Professional deck"],
    featured: true,
    color: "#15A9FF",
  },
];
...
const CFO_TIERS = [
  {
    title: "Starter",
    price: "₹10,000/mo",
    features: ["Bookkeeping setup", "Compliance framework", "Cash flow tracking", "Founder advisory"],
    recommended: false,
    color: "#15A9FF",
  },
  {
    title: "Growth",
    price: "₹25,000/mo",
    features: ["Monthly MIS", "Burn analysis", "Unit economics", "Investor updates"],
    recommended: true,
    color: "#15A9FF",
  },
  {
    title: "CFO Partner",
    price: "₹50,000/mo",
    features: ["Strategic oversight", "Board reporting", "Due diligence support", "Fundraising readiness"],
    recommended: false,
    color: "#00C853",
  },
];
    ...
    <section id="studio" className="py-24 px-6 md:px-10 relative">
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <p className="text-lg text-white/50 mb-16 max-w-xl">
          Bespoke services to ensure your startup is institutional-grade.
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-20">
          {SERVICES.map((svc, i) => (
            ...
            >
              {svc.featured && (
                <Badge className="absolute top-4 right-4 bg-[#15A9FF] text-white text-[10px] rounded-full px-2.5">
                  Best Value
                </Badge>
              )}
              <div className="absolute top-0 right-0 w-20 h-20 blur-2xl rounded-full opacity-20" style={{ background: svc.color }} />
              <div>
                <div className="text-2xl font-bold text-white mb-1" style={{ fontFamily: "'Space Grotesk', sans-serif", color: svc.color }}>{svc.price}</div>
              ...
              <Button
                data-testid={`button-pay-service-${i}`}
        ...
        {/* Fractional CFO */}
        <div className="mb-20">
          <h3 className="text-2xl font-bold text-white mb-2" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>Fractional CFO Intelligence</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {CFO_TIERS.map((tier, i) => (
              ...
              >
                {tier.recommended && (
                  <div className="absolute top-0 inset-x-0 h-1 bg-gradient-to-r from-[#15A9FF] to-[#00C853] rounded-t-2xl" />
                )}
                <div className="absolute top-0 right-0 w-24 h-24 blur-3xl rounded-full opacity-10" style={{ background: tier.color }} />
                {tier.recommended && (
                  <Badge className="absolute top-4 right-4 bg-[#15A9FF]/10 text-[#15A9FF] border border-[#15A9FF]/30 text-[10px] rounded-full">
                    Recommended
                  </Badge>
                )}
                <h4 className="font-bold text-white text-lg mb-1" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>{tier.title}</h4>
                ...
                <Button
                  data-testid={`button-cfo-enquire-${i}`}
        ...
        {/* Strategic Add-Ons */}
        <div>
          <h3 className="text-2xl font-bold text-white mb-2" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>Strategic Add-Ons</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3">
            {ADD_ONS.map((addon, i) => (
              <div
                ...
                className="glass-card rounded-xl p-4 flex items-center justify-between cursor-pointer group"
              >
                <span className="text-sm text-white/80 font-medium">{addon.title}</span>
